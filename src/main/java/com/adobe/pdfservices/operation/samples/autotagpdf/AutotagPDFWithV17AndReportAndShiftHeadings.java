...
/**
 * This sample illustrates how to generate a tagged PDF of version 1.7 and shift its headings and a report from a PDF.
 * <p>
 * Refer to README.md for instructions on how to run the samples & understand output tagged pdf and report.
 */
