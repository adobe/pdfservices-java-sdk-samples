...
/**
 * This sample illustrates how to generate a tagged PDF with version 1.7 and report file from PDF.
 * <p>
 * Refer to README.md for instructions on how to run the samples & understand output a tagged pdf and a report.
 */
