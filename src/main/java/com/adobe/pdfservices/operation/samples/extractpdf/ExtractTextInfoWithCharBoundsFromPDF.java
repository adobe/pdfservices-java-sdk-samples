...
public class ExtractTextInfoWithCharBoundsFromPDF {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ExtractTextInfoWithCharBoundsFromPDF.class);
    ...
    public static String createOutputFilePath() throws IOException {
        ...
        Files.createDirectories(Paths.get("output/ExtractTextInfoWithCharBoundsFromPDF"));
