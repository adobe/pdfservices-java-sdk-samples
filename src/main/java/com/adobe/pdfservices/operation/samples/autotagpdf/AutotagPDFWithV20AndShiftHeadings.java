...
/**
 * This sample illustrates how to generate a tagged PDF of version 2.0 and shift its headings from a PDF.
 * <p>
 * Refer to README.md for instructions on how to run the samples & understand output tagged pdf with pdf version 2.0.
 */
